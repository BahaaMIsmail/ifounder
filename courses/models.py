...
class Question(models.Model):
    ...
    l = models.ForeignKey(Lesson, on_delete=models.CASCADE) 
    u = models.ForeignKey(Unit, on_delete=models.CASCADE) 
    s = models.ForeignKey(Subject, on_delete=models.CASCADE) 
